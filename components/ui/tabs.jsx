...
const TabsContent = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "min-h-[480px] ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1C1B22] focus-visible:ring-offset-2 dark:ring-offset-[#1C1B22] dark:focus-visible:ring-slate-300",
      className
    )}
    {...props}
  />
